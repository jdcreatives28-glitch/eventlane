...
import './BookingModal.css'; // reuse the same styles
...
export default function BookingForm() {
  const { id } = useParams(); // /venues/:id/book
  ...
  useEffect(() => {
    (async () => {
      ...
      if (error) {
        ...
        Swal.fire('Error', 'Unable to load venue details.', 'error');
      }
      setVenue(data || null);
  ...
  if (loadingVenue) {
    return (
      <div className="booking-form-page" style={{ padding: 16 }}>
  ...
  const titleId = 'booking-form-title';

  return (
    <div className="booking-form-page" style={{ padding: 16, minHeight: '100vh' }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        {/* Reuse the modal layout as a card */}
                  ...
                  <div className="field">
                    ...
                    <TimePicker
                      ...
                      onTimeChange={(time) => {
                        ...
                        const nextEnd =
                          form.end_time && form.end_time >= newEndMin
                            ? form.end_time
                            : '';
                        setForm((prev) => ({
                          ...prev,
